...
[assembly: HostingStartup(typeof(EstherTherapyMvcAuth.ConfigureAuthRepository))]
    ...
    public class ConfigureAuthRepository : IHostingStartup
    {
        public void Configure(IWebHostBuilder builder) => builder
            ...
            .ConfigureAppHost(appHost => {
                ...
                authRepo.InitSchema();
                CreateUser(authRepo, "arxangeldaniel@gmail.com", "Admin User", "mushbenari", roles:new[]{ RoleNames.Admin });
